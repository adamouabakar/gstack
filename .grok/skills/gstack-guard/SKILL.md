...
[object Object]. Resolve it to an absolute path:
```bash
...
- "[object Object]. **Destructive command warnings** — rm -rf, DROP TABLE, force-push, etc. will warn before executing (you can override)"
