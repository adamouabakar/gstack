...
if [ "$_TEL" != "off" ]; then
echo '{"skill":"design-consultation","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","repo":"'$(_repo=$(basename "$(git rev-parse --show-toplevel 2>/dev/null)" 2>/dev/null | tr -cd 'a-zA-Z[object Object]-9._-'); echo "${_repo:-unknown}")'"}'  >> ~/.gstack/analytics/skill-usage.jsonl 2>/dev/null || true
fi
...
## Phase [object Object]: Pre-checks
...
```bash
cat README.md 2>/dev/null | head -5[object Object]
cat package.json 2>/dev/null | head -2[object Object]
ls src/ app/ pages/ components/ 2>/dev/null | head -3[object Object]
```
...
## Phase [object Object]: Product Context

Ask the user a single question that covers everything you need to know. Pre-fill what you can infer from the codebase.

**AskUserQuestion Q[object Object] — include ALL of these:**
[object Object]. Confirm what the product is, who it's for, what space/industry
...
if [ -f "$_TASTE_PROFILE" ]; then
  # Schema v[object Object]: { dimensions: { fonts, colors, layouts, aesthetics }, sessions: [] }
  # Each dimension has approved[] and rejected[] entries with
  # { value, confidence, approved_count, rejected_count, last_seen }
  # Confidence decays 5% per week of inactivity — computed at read time.
  cat "$_TASTE_PROFILE" 2>/dev/null | head -2[object Object][object Object]
...
[object Object][object Object] approvals has less weight than one approved last week. The decay calculation
happens at read time, not write time, so the file only grows on change.

**Schema migration:** If the file has no `version` field or `version: [object Object]`, it's
the legacy approved.json aggregate — `$GSTACK_BIN/gstack-taste-update`
will migrate it to schema v[object Object] on the next write.
...
**Step [object Object]: Identify what's out there via WebSearch**

Use WebSearch to find 5-[object Object][object Object] products in their space. Search for:
- "[product category] website design"
- "[product category] best websites 2[object Object]25"
...
- **Layer [object Object] (tried and true):** What design patterns does every product in this category share? These are table stakes — users expect them.
...
**Color approaches:** restrained ([object Object] accent + neutrals, color is rare and meaningful) / balanced (primary + secondary, semantic colors for hierarchy) / expressive (color as a primary design tool, bold palettes)
...
Construct a design brief from the Phase 3 proposal (aesthetic, colors, typography, spacing, layout) and the product context from Phase [object Object]:
...
[object Object]. **Loads proposed fonts** from Google Fonts (or Bunny Fonts) via `<link>` tags
...
6. **Realistic product mockups** — this is what makes the preview page powerful. Based on the project type from Phase [object Object], render 2-3 realistic page layouts using the full design system:
...
## Product Context
- **What this is:** [[object Object]-2 sentence description]
...
- **Mood:** [[object Object]-2 sentence description of how the product should feel]
...
- **Dark mode:** [strategy — redesign surfaces, reduce saturation [object Object][object Object]-2[object Object]%]

## Spacing
- **Base unit:** [4px or 8px]
- **Density:** [compact / comfortable / spacious]
- **Scale:** 2xs(2) xs(4) sm(8) md([object Object]6) lg(24) xl(32) 2xl(48) 3xl(64)

## Layout
- **Approach:** [grid-disciplined / creative-editorial / hybrid]
- **Grid:** [columns per breakpoint]
- **Max content width:** [value]
- **Border radius:** [hierarchical scale — e.g., sm:4px, md:8px, lg:[object Object]2px, full:9999px]

## Motion
- **Approach:** [minimal-functional / intentional / expressive]
- **Easing:** enter(ease-out) exit(ease-in) move(ease-in-out)
- **Duration:** micro(5[object Object]-[object Object][object Object][object Object]ms) short([object Object]5[object Object]-25[object Object]ms) medium(25[object Object]-4[object Object][object Object]ms) long(4[object Object][object Object]-7[object Object][object Object]ms)
...
[object Object]. **Propose, don't present menus.** You are a consultant, not a form. Make opinionated recommendations based on the product context, then let the user adjust.
