...
description: |
  ...
  scanning, plus OWASP Top [object Object][object Object], STRIDE threat modeling, and active verification.
  Two modes: daily (zero-noise, 8/[object Object][object Object] confidence gate) and comprehensive (monthly deep
  scan, 2/[object Object][object Object] bar). Trend tracking across audit runs.
...
if [ "$_TEL" != "off" ]; then
echo '{"skill":"cso","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","repo":"'$(_repo=$(basename "$(git rev-parse --show-toplevel 2>/dev/null)" 2>/dev/null | tr -cd 'a-zA-Z[object Object]-9._-'); echo "${_repo:-unknown}")'"}'  >> ~/.gstack/analytics/skill-usage.jsonl 2>/dev/null || true
fi
...
## Arguments
- `/cso` — full daily audit (all phases, 8/[object Object][object Object] confidence gate)
- `/cso --comprehensive` — monthly deep scan (all phases, 2/[object Object][object Object] bar — surfaces more)
- `/cso --infra` — infrastructure-only (Phases [object Object]-6, [object Object]2-[object Object]4)
- `/cso --code` — code-only (Phases [object Object]-[object Object], 7, 9-[object Object][object Object], [object Object]2-[object Object]4)
- `/cso --skills` — skill supply chain only (Phases [object Object], 8, [object Object]2-[object Object]4)
- `/cso --diff` — branch changes only (combinable with any above)
- `/cso --supply-chain` — dependency audit only (Phases [object Object], 3, [object Object]2-[object Object]4)
- `/cso --owasp` — OWASP Top [object Object][object Object] only (Phases [object Object], 9, [object Object]2-[object Object]4)
- `/cso --scope auth` — focused audit on a specific domain

## Mode Resolution

[object Object]. If no flags → run ALL phases [object Object]-[object Object]4, daily mode (8/[object Object][object Object] confidence gate).
2. If `--comprehensive` → run ALL phases [object Object]-[object Object]4, comprehensive mode (2/[object Object][object Object] confidence gate). Combinable with scope flags.
...
6. Phases [object Object], [object Object], [object Object]2, [object Object]3, [object Object]4 ALWAYS run regardless of scope flag.
...
### Phase [object Object]: Architecture Mental Model + Stack Detection
...
find . -maxdepth [object Object] \( -name '*.csproj' -o -name '*.sln' \) 2>/dev/null | grep -q . && echo "STACK: .NET"
```
...
### Phase [object Object]: Attack Surface Census

Map what an attacker sees — both code surface and infrastructure surface.

**Code surface:** Use the Grep tool to find endpoints, auth boundaries, external integrations, file upload paths, admin routes, webhook handlers, background jobs, and WebSocket channels. Scope file extensions to detected stacks from Phase [object Object]. Count each category.

**Infrastructure surface:**
```bash
setopt +o nomatch 2>/dev/null || true  # zsh compat
{ find .github/workflows -maxdepth [object Object] \( -name '*.yml' -o -name '*.yaml' \) 2>/dev/null; [ -f .gitlab-ci.yml ] && echo .gitlab-ci.yml; } | wc -l
...
**Scope gate (read first).** This section holds every scope-dependent phase (2-[object Object][object Object]), but you run ONLY the phases your resolved mode selected back in `## Mode Resolution` (always-loaded in the skeleton). Phases [object Object], [object Object], [object Object]2, [object Object]3, [object Object]4 always run; Phases 2-[object Object][object Object] are scope-gated. "Execute in full" means work through this section applying that selection, NOT run a phase your mode did not select just because its prose lives here. Example: `--owasp` runs Phase 9 from this section, not Phases 2-8/[object Object][object Object]/[object Object][object Object].
...
```bash
for f in $(find .github/workflows -maxdepth [object Object] \( -name '*.yml' -o -name '*.yaml' \) 2>/dev/null) .gitlab-ci.yml .circleci/config.yml; do
...
**FP rules:** First-party `actions/*` unpinned = MEDIUM not HIGH. `pull_request_target` without PR ref checkout is safe (precedent #[object Object][object Object]). Secrets in `with:` blocks (not `env:`/`run:`) are handled by runtime.
...
**Config files with prod credentials:** Use Grep to search for database connection strings (postgres://, mysql://, mongodb://, redis://) in config files, excluding localhost/[object Object]27.[object Object].[object Object].[object Object]/example.com. Check for staging/dev configs referencing prod.
...
**FP rules:** `docker-compose.yml` for local dev with localhost = not a finding (precedent #[object Object]2). Terraform `"*"` in `data` sources (read-only) excluded. K8s manifests in `test/`/`dev/`/`local/` with localhost networking excluded.
...
**TLS verification disabled:** Use Grep to search for patterns like `verify.*false`, `VERIFY_NONE`, `InsecureSkipVerify`, `NODE_TLS_REJECT_UNAUTHORIZED.*[object Object]`.
...
**FP rules:** User content in the user-message position of an AI conversation is NOT prompt injection (precedent #[object Object]3). Only flag when user content enters system prompts, tool schemas, or function-calling contexts.

### Phase 8: Skill Supply Chain

Scan installed Claude Code skills for malicious patterns. 36% of published skills have security flaws, [object Object]3.4% are outright malicious (Snyk ToxicSkills research).

**Tier [object Object] — repo-local (automatic):** Scan the repo's local skills directory for suspicious patterns:
...
### Phase 9: OWASP Top [object Object][object Object] Assessment

For each OWASP category, perform targeted analysis. Use the Grep tool for all searches — scope file extensions to detected stacks from Phase [object Object].

#### A[object Object][object Object]: Broken Access Control
...
#### A[object Object]2: Cryptographic Failures
- Weak crypto (MD5, SHA[object Object], DES, ECB) or hardcoded secrets
- Is sensitive data encrypted at rest and in transit?
- Are keys/secrets properly managed (env vars, not hardcoded)?

#### A[object Object]3: Injection
...
#### A[object Object]4: Insecure Design
- Rate limits on authentication endpoints?
- Account lockout after failed attempts?
- Business logic validated server-side?

#### A[object Object]5: Security Misconfiguration
- CORS configuration (wildcard origins in production?)
- CSP headers present?
- Debug mode / verbose errors in production?

#### A[object Object]6: Vulnerable and Outdated Components
See **Phase 3 (Dependency Supply Chain)** for comprehensive component analysis.

#### A[object Object]7: Identification and Authentication Failures
...
#### A[object Object]8: Software and Data Integrity Failures
...
#### A[object Object]9: Security Logging and Monitoring Failures
- Authentication events logged?
- Authorization failures logged?
- Admin actions audit-trailed?
- Logs protected from tampering?

#### A[object Object][object Object]: Server-Side Request Forgery (SSRF)
- URL construction from user input?
- Internal service reachability from user-controlled URLs?
- Allowlist/blocklist enforcement on outbound requests?

### Phase [object Object][object Object]: STRIDE Threat Model

For each major component identified in Phase [object Object], evaluate:
...
### Phase [object Object][object Object]: Data Classification
...
```
### Phase [object Object]2: False Positive Filtering + Active Verification

Before producing findings, run every candidate through this filter.

**Two modes:**

**Daily mode (default, `/cso`):** 8/[object Object][object Object] confidence gate. Zero noise. Only report what you're sure about.
- 9-[object Object][object Object]: Certain exploit path. Could write a PoC.
- 8: Clear vulnerability pattern with known exploitation methods. Minimum bar.
- Below 8: Do not report.

**Comprehensive mode (`/cso --comprehensive`):** 2/[object Object][object Object] confidence gate. Filter true noise only (test fixtures, documentation, placeholders) but include anything that MIGHT be a real issue. Flag these as `TENTATIVE` to distinguish from confirmed findings.

**Hard exclusions — automatically discard findings matching these:**

[object Object]. Denial of Service (DOS), resource exhaustion, or rate limiting issues — **EXCEPTION:** LLM cost/spend amplification findings from Phase 7 (unbounded LLM calls, missing cost caps) are NOT DoS — they are financial risk and must NOT be auto-discarded under this rule.
...
[object Object][object Object]. Files that are only unit tests or test fixtures AND not imported by non-test code
[object Object][object Object]. Log spoofing — outputting unsanitized input to logs is not a vulnerability
[object Object]2. SSRF where attacker only controls the path, not the host or protocol
[object Object]3. User content in the user-message position of an AI conversation (NOT prompt injection)
[object Object]4. Regex complexity in code that does not process untrusted input (ReDoS on user strings IS real)
[object Object]5. Security concerns in documentation files (*.md) — **EXCEPTION:** SKILL.md files are NOT documentation. They are executable prompt code (skill definitions) that control AI agent behavior. Findings from Phase 8 (Skill Supply Chain) in SKILL.md files must NEVER be excluded under this rule.
[object Object]6. Missing audit logs — absence of logging is not a vulnerability
[object Object]7. Insecure randomness in non-security contexts (e.g., UI element IDs)
[object Object]8. Git history secrets committed AND removed in the same initial-setup PR
[object Object]9. Dependency CVEs with CVSS < 4.[object Object] and no known exploit
2[object Object]. Docker issues in files named `Dockerfile.dev` or `Dockerfile.local` unless referenced in prod deploy configs
2[object Object]. CI/CD findings on archived or disabled workflows
22. Skill files that are part of gstack itself (trusted source)

**Precedents:**

[object Object]. Logging secrets in plaintext IS a vulnerability. Logging URLs is safe.
...
[object Object][object Object]. Lockfile not tracked by git IS a finding for app repos, NOT for library repos.
[object Object][object Object]. `pull_request_target` without PR ref checkout is safe.
[object Object]2. Containers running as root in `docker-compose.yml` for local dev are NOT findings; in production Dockerfiles/K8s ARE findings.

**Active Verification:**

For each finding that survives the confidence gate, attempt to PROVE it where safe:

[object Object]. **Secrets:** Check if the pattern is a real key format (correct length, valid prefix). DO NOT test against live APIs.
...
- `TENTATIVE` — comprehensive mode finding below 8/[object Object][object Object] confidence
...
[object Object]. Extract the core vulnerability pattern
...
- "Read the code at this location. Assess independently: is there a security vulnerability here? Score [object Object]-[object Object][object Object]. Below 8 = explain why it's not real."
...
### Phase [object Object]3: Findings Report + Trend Tracking + Remediation
...
──  ────   ────   ──────      ────────         ───────                          ─────   ─────────
[object Object]   CRIT   9/[object Object][object Object]   VERIFIED    Secrets          AWS key in git history           P2      .env:3
2   CRIT   9/[object Object][object Object]   VERIFIED    CI/CD            pull_request_target + checkout   P4      .github/ci.yml:[object Object]2
3   HIGH   8/[object Object][object Object]   VERIFIED    Supply Chain     postinstall in prod dep          P3      node_modules/foo
4   HIGH   9/[object Object][object Object]   UNVERIFIED  Integrations     Webhook w/o signature verify     P6      api/webhooks.ts:24
```
...
* **Confidence:** N/[object Object][object Object]
* **Status:** VERIFIED | UNVERIFIED | TENTATIVE
* **Phase:** N — [Phase Name]
* **Category:** [Secrets | Supply Chain | CI/CD | Infrastructure | Integrations | LLM Security | Skill Supply Chain | OWASP A[object Object][object Object]-A[object Object][object Object]]
...
[object Object]. **Revoke** the credential immediately
...
[object Object]. Context: The vulnerability, its severity, exploitation scenario
...
### Phase [object Object]4: Save Report
...
```json
{
  "version": "2.[object Object].[object Object]",
  "date": "ISO-86[object Object][object Object]-datetime",
  "mode": "daily | comprehensive",
  "scope": "full | infra | code | skills | supply-chain | owasp",
  "diff_mode": false,
  "phases_run": [[object Object], [object Object], 2, 3, 4, 5, 6, 7, 8, 9, [object Object][object Object], [object Object][object Object], [object Object]2, [object Object]3, [object Object]4],
  "attack_surface": {
    "code": { "public_endpoints": [object Object], "authenticated": [object Object], "admin": [object Object], "api": [object Object], "uploads": [object Object], "integrations": [object Object], "background_jobs": [object Object], "websockets": [object Object] },
    "infrastructure": { "ci_workflows": [object Object], "webhook_receivers": [object Object], "container_configs": [object Object], "iac_configs": [object Object], "deploy_targets": [object Object], "secret_management": "unknown" }
  },
  "findings": [{
    "id": [object Object],
    "severity": "CRITICAL",
  ...
  "supply_chain_summary": {
    "direct_deps": [object Object], "transitive_deps": [object Object],
    "critical_cves": [object Object], "high_cves": [object Object],
    "install_scripts": [object Object], "lockfile_present": true, "lockfile_tracked": true,
    "tools_skipped": []
  },
  "filter_stats": {
    "candidates_scanned": [object Object], "hard_exclusion_filtered": [object Object],
    "confidence_gate_filtered": [object Object], "verification_filtered": [object Object], "reported": [object Object]
  },
  "totals": { "critical": [object Object], "high": [object Object], "medium": [object Object], "tentative": [object Object] },
  "trend": {
    "prior_report_date": null,
    "resolved": [object Object], "persistent": [object Object], "new": [object Object],
    "direction": "first_run"
  }
}
```
...
- **Zero noise is more important than zero misses.** A report with 3 real findings beats one with 3 real + [object Object]2 theoretical. Users stop reading noisy reports.
...
- **Confidence gate is absolute.** Daily mode: below 8/[object Object][object Object] = do not report. Period.
