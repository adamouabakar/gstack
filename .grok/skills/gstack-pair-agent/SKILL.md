...
if [ "$_TEL" != "off" ]; then
echo '{"skill":"pair-agent","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","repo":"'$(_repo=$(basename "$(git rev-parse --show-toplevel 2>/dev/null)" 2>/dev/null | tr -cd 'a-zA-Z[object Object]-9._-'); echo "${_repo:-unknown}")'"}'  >> ~/.gstack/analytics/skill-usage.jsonl 2>/dev/null || true
fi
...
## Step [object Object]: Check prerequisites
...
[object Object]. Go to https://dashboard.ngrok.com/get-started/your-authtoken
...
[object Object]. Go to https://ngrok.com and sign up (free tier works)
2. Install ngrok:
...
**"Rate limit exceeded"** — The agent is sending > [object Object][object Object] requests/second. It should
