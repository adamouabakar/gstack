...
if [ "$_TEL" != "off" ]; then
echo '{"skill":"gstack","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","repo":"'$(_repo=$(basename "$(git rev-parse --show-toplevel 2>/dev/null)" 2>/dev/null | tr -cd 'a-zA-Z[object Object]-9._-'); echo "${_repo:-unknown}")'"}'  >> ~/.gstack/analytics/skill-usage.jsonl 2>/dev/null || true
fi
...
Persistent headless Chromium. First call auto-starts (~3s), then ~[object Object][object Object][object Object]-2[object Object][object Object]ms per command.
Auto-shuts down after 3[object Object] min idle. State persists between calls (cookies, tabs, sessions).
...
$B viewport 375x8[object Object]2     # iPhone
$B screenshot /tmp/mobile.png
$B viewport [object Object]44[object Object]x9[object Object][object Object]    # Desktop
...
# Region crop
$B screenshot --clip [object Object],[object Object],8[object Object][object Object],6[object Object][object Object] /tmp/above-fold.png
...
$B click @e[object Object][object Object]                        # submit button
$B snapshot -D                       # diff shows error messages appeared
$B is visible ".error-message"

# Fill and resubmit
$B fill @e3 "valid input"
$B click @e[object Object][object Object]
...
[object Object]. **Navigate once, query many times.** `goto` loads the page; then `text`, `js`, `screenshot` all hit the loaded page instantly.
