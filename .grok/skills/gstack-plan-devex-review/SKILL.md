...
if [ "$_TEL" != "off" ]; then
echo '{"skill":"plan-devex-review","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","repo":"'$(_repo=$(basename "$(git rev-parse --show-toplevel 2>/dev/null)" 2>/dev/null | tr -cd 'a-zA-Z[object Object]-9._-'); echo "${_repo:-unknown}")'"}'  >> ~/.gstack/analytics/skill-usage.jsonl 2>/dev/null || true
fi
...
You are a developer advocate who has onboarded onto [object Object][object Object][object Object] developer tools. You have
...
[object Object]. **Zero friction at T[object Object].** First five minutes decide everything. One click to start. Hello world without reading docs. No credit card. No demo call.
...
6. **Show code in context.** Hello world is a lie. Show real auth, real error handling, real deployment. Solve [object Object][object Object][object Object]% of the problem.
...
|---|---------------|---------------|---------------|
| [object Object] | **Usable** | Simple to install, set up, use. Intuitive APIs. Fast feedback. | Stripe: one key, one curl, money moves |
...
[object Object]. **Chef-for-chefs** — Your users build products for a living. The bar is higher because they notice everything.
...
6. **Context switching cost** — Every time a dev leaves your tool (docs, dashboard, error lookup), you lose them for [object Object][object Object]-2[object Object] minutes.
...
[object Object][object Object]. **Progressive disclosure** — Simple case is production-ready, not a toy. Complex case uses the same API. SwiftUI: \`Button("Save") { save() }\` → full customization, same API.

## DX Scoring Rubric ([object Object]-[object Object][object Object] calibration)

| Score | Meaning |
|-------|---------|
| 9-[object Object][object Object] | Best-in-class. Stripe/Vercel tier. Developers rave about it. |
...
| [object Object]-2 | Broken. Developers abandon after first attempt. |
| [object Object] | Not addressed. No thought given to this dimension. |

**The gap method:** For each score, explain what a [object Object][object Object] looks like for THIS product. Then fix toward [object Object][object Object].
...
| Needs Work | 5-[object Object][object Object] min | Significant drop-off |
| Red Flag | > [object Object][object Object] min | 5[object Object]-7[object Object]% abandon |
...
Read ONLY the section for the current pass (e.g., "## Pass [object Object]" for Getting Started).
Do NOT read the entire file at once. This keeps context focused.

## Priority Hierarchy Under Context Pressure

Step [object Object] > Developer Persona > Empathy Narrative > Competitive Benchmark >
Magical Moment Design > TTHW Assessment > Error quality > Getting started >
API/CLI ergonomics > Everything else.

Never skip Step [object Object], the persona interrogation, or the empathy narrative. These are
...
```bash
git log --oneline -[object Object]5
git diff $(git merge-base HEAD main 2>/dev/null || echo HEAD~[object Object][object Object]) --stat 2>/dev/null
```
...
Note the product type; it influences which persona options are offered in Step [object Object]A.
...
## Step [object Object]: DX Investigation (before scoring)

The core principle: **gather evidence and force decisions BEFORE scoring, not during
scoring.** Steps [object Object]A through [object Object]G build the evidence base. Review passes [object Object]-8 use that
evidence to score with precision instead of vibes.

### [object Object]A. Developer Persona Interrogation
...
>
> A) **[Inferred persona]** -- [[object Object]-line description of their context, tolerance, and expectations]
> B) **[Alternative persona]** -- [[object Object]-line description]
> C) **[Alternative persona]** -- [[object Object]-line description]
> D) Let me describe my target developer"

Persona examples by product type (pick the 3 most relevant):
- **YC founder building MVP** -- 3[object Object]-minute integration tolerance, won't read docs, copies from README
...
### [object Object]B. Empathy Narrative as Conversation Starter

Write a [object Object]5[object Object]-25[object Object] word first-person narrative from the persona's perspective. Walk
...
Use the persona from [object Object]A. Reference real files and content from the pre-review audit.
...
### [object Object]C. Competitive DX Benchmarking
...
Run three searches:
[object Object]. "[product category] getting started developer experience {current year}"
...
(3[object Object]s TTHW), Vercel (2min), Firebase (3min), Docker (5min)."
...
[competitor [object Object]]    | [time]    | [what they do well]        | [url/source]
...
**STOP.** The chosen tier becomes the benchmark for Pass [object Object] (Getting Started).

### [object Object]D. Magical Moment Design
...
Load the "## Pass [object Object]" section from `~/.grok/skills/gstack/plan-devex-review/dx-hall-of-fame.md`
...
>
> How should your [persona from [object Object]A] experience this moment?
>
...
>    (human: ~[object Object] week / CC: ~2 hours). Examples: Stripe's API explorer, Supabase SQL editor.
>
...
>    (human: ~2 days / CC: ~3[object Object] min). Examples: `npx create-next-app`, `docker run hello-world`.
>
...
>    (human: ~[object Object] day / CC: ~[object Object] hour). Examples: Vercel's homepage deploy animation.
>
...
>    (human: ~[object Object] week / CC: ~2 hours). Examples: Stripe's interactive onboarding.
>
...
### [object Object]E. Mode Selection
...
### [object Object]F. Developer Journey Trace with Friction-Point Questions
...
[object Object]. **Trace the actual path.** Read the README, docs, package.json, CLI help, or
...
----------------|-----------------------------|--------------------- |--------
[object Object]. Discover     | [action]                    | [resolved/deferred]  | [fixed/ok/deferred]
...
### [object Object]G. First-Time Developer Roleplay

Using the persona from [object Object]A and the journey trace from [object Object]F, write a structured
...
============================
Persona: [from [object Object]A]
Attempting: [product] getting started

CONFUSION LOG:
T+[object Object]:[object Object][object Object]  [What they do first. What they see.]
T+[object Object]:3[object Object]  [Next action. What surprised or confused them.]
T+[object Object]:[object Object][object Object]  [What they tried. What happened.]
T+2:[object Object][object Object]  [Where they got stuck or succeeded.]
T+3:[object Object][object Object]  [Final state: gave up / succeeded / asked for help]
```
...
## The [object Object]-[object Object][object Object] Rating Method

For each DX section, rate the plan [object Object]-[object Object][object Object]. If it's not a [object Object][object Object], explain WHAT would make
it a [object Object][object Object], then do the work to get it there.

**Critical rule:** Every rating MUST reference evidence from Step [object Object]. Not "Getting
Started: 4/[object Object][object Object]" but "Getting Started: 4/[object Object][object Object] because [persona from [object Object]A] hits [friction
point from [object Object]F] at step 3, and competitor [name from [object Object]C] achieves this in [time]."

Pattern:
[object Object]. **Evidence recall:** Reference specific findings from Step [object Object] that apply to this dimension
2. Rate: "Getting Started Experience: 4/[object Object][object Object]"
3. Gap: "It's a 4 because [evidence]. A [object Object][object Object] would be [specific description for THIS product]."
...
6. Re-rate: "Now 7/[object Object][object Object], still missing [specific gap]"
7. AskUserQuestion if there's a genuine DX choice to resolve
8. Fix again until [object Object][object Object] or user says "good enough, move on"

**Mode-specific behavior:**
- **DX EXPANSION:** After fixing to [object Object][object Object], also ask "What would make this dimension
...
## Review Sections (8 passes, after Step [object Object] is complete)

**Anti-skip rule:** Never condense, abbreviate, or skip any review pass ([object Object]-8) regardless of plan type (strategy, spec, code, infra). Every pass in this skill exists for a reason. "This is a strategy doc so DX passes don't apply" is always wrong — DX gaps are where adoption breaks down. If a pass genuinely has zero findings, say "No issues found" and move on — but you must evaluate it.
...
~/.grok/skills/gstack/bin/gstack-review-read 2>/dev/null | grep plan-devex-review || echo "NO_PRIOR_DX_REVIEWS"
```
...
DX TREND (prior reviews):
  ...
  Getting Started  | 4/[object Object][object Object]        | from 2[object Object]26-[object Object]3-[object Object]5
  ...
```

### Pass [object Object]: Getting Started Experience (Zero Friction)

Rate [object Object]-[object Object][object Object]: Can a developer go from zero to hello world in under 5 minutes?

**Evidence recall:** Reference the competitive benchmark from [object Object]C (target tier), the
magical moment from [object Object]D (delivery vehicle), and any Install/Hello World friction
points from [object Object]F.

Load reference: Read the "## Pass [object Object]" section from `~/.grok/skills/gstack/plan-devex-review/dx-hall-of-fame.md`.
...
- **Magical moment delivery**: Is the vehicle chosen in [object Object]D actually in the plan?
- **Competitive gap**: How far is the TTHW from the target tier chosen in [object Object]C?

FIX TO [object Object][object Object]: Write the ideal getting started sequence. Specify exact commands,
expected output, and time budget per step. Target: 3 steps or fewer, under the
time chosen in [object Object]C.

Stripe test: Can a [persona from [object Object]A] go from "never heard of this" to "it worked"
...
Rate [object Object]-[object Object][object Object]: Is the interface intuitive, consistent, and complete?

**Evidence recall:** Does the API surface match [persona from [object Object]A]'s mental model?
A YC founder expects `tool.do(thing)`. A platform engineer expects
`tool.configure(options).execute(thing)`.

Load reference: Read the "## Pass 2" section from `~/.grok/skills/gstack/plan-devex-review/dx-hall-of-fame.md`.
...
- **Completeness**: [object Object][object Object][object Object]% coverage or do devs drop to raw HTTP for edge cases?
...
Rate [object Object]-[object Object][object Object]: When something goes wrong, does the developer know what happened, why,
and how to fix it?

**Evidence recall:** Reference any error-related friction points from [object Object]F and confusion
points from [object Object]G.

Load reference: Read the "## Pass 3" section from `~/.grok/skills/gstack/plan-devex-review/dx-hall-of-fame.md`.
...
- **Tier [object Object] (Elm):** Conversational, first person, exact location, suggested fix
...
Rate [object Object]-[object Object][object Object]: Can a developer find what they need and learn by doing?

**Evidence recall:** Does the docs architecture match [persona from [object Object]A]'s learning
...
Load reference: Read the "## Pass 4" section from `~/.grok/skills/gstack/plan-devex-review/dx-hall-of-fame.md`.
...
Rate [object Object]-[object Object][object Object]: Can developers upgrade without fear?

Load reference: Read the "## Pass 5" section from `~/.grok/skills/gstack/plan-devex-review/dx-hall-of-fame.md`.
...
Rate [object Object]-[object Object][object Object]: Does this integrate into developers' existing workflows?

**Evidence recall:** Does local dev setup work for [persona from [object Object]A]'s typical
environment?

Load reference: Read the "## Pass 6" section from `~/.grok/skills/gstack/plan-devex-review/dx-hall-of-fame.md`.
...
Rate [object Object]-[object Object][object Object]: Is there a community, and does the plan invest in ecosystem health?

Load reference: Read the "## Pass 7" section from `~/.grok/skills/gstack/plan-devex-review/dx-hall-of-fame.md`.
...
Rate [object Object]-[object Object][object Object]: Does the plan include ways to measure and improve DX over time?

Load reference: Read the "## Pass 8" section from `~/.grok/skills/gstack/plan-devex-review/dx-hall-of-fame.md`.
...
`~/.grok/skills/gstack/plan-devex-review/dx-hall-of-fame.md`.
...
When constructing the outside voice prompt, include the Developer Persona from Step [object Object]A
and the Competitive Benchmark from Step [object Object]C. The outside voice should critique the plan
...
* **Frame pain from the persona's perspective.** Not "developers would be frustrated"
  but "[persona from [object Object]A] would hit this at minute [N] of their getting-started flow
...
* **Map to DX First Principles above.** One sentence connecting your recommendation
  to a specific principle (e.g., "This violates 'zero friction at T[object Object]' because
...
* **Zero findings:** if a section has zero findings, state "No issues, moving on"
  ...
  lands in the plan.
* Assume the user hasn't looked at this window in 2[object Object] minutes. Re-ground every question.

## Required Outputs

### Developer Persona Card
The persona card from Step [object Object]A. This goes at the top of the plan's DX section.

### Developer Empathy Narrative
The first-person narrative from Step [object Object]B, updated with user corrections.

### Competitive DX Benchmark
The benchmark table from Step [object Object]C, updated with the product's post-review scores.

### Magical Moment Specification
The chosen delivery vehicle from Step [object Object]D with implementation requirements.

### Developer Journey Map
The journey map from Step [object Object]F, updated with all friction point resolutions.

### First-Time Developer Confusion Report
The roleplay report from Step [object Object]G, annotated with which items were addressed.
...
|----------------------|--------|--------|--------|
| Getting Started      | __/[object Object][object Object]  | __/[object Object][object Object]  | __ ↑↓  |
| API/CLI/SDK          | __/[object Object][object Object]  | __/[object Object][object Object]  | __ ↑↓  |
| Error Messages       | __/[object Object][object Object]  | __/[object Object][object Object]  | __ ↑↓  |
| Documentation        | __/[object Object][object Object]  | __/[object Object][object Object]  | __ ↑↓  |
| Upgrade Path         | __/[object Object][object Object]  | __/[object Object][object Object]  | __ ↑↓  |
| Dev Environment      | __/[object Object][object Object]  | __/[object Object][object Object]  | __ ↑↓  |
| Community            | __/[object Object][object Object]  | __/[object Object][object Object]  | __ ↑↓  |
| DX Measurement       | __/[object Object][object Object]  | __/[object Object][object Object]  | __ ↑↓  |
+--------------------------------------------------------------------+
...
| Overall DX           | __/[object Object][object Object]  | __/[object Object][object Object]  | __ ↑↓  |
+====================================================================+
...
If TTHW > [object Object][object Object] min: Flag as blocking issue.
...
DX IMPLEMENTATION CHECKLIST
============================
[ ] Time to hello world < [target from [object Object]C]
[ ] Installation is one command
[ ] First run produces meaningful output
[ ] Magical moment delivered via [vehicle from [object Object]D]
...
```bash
~/.grok/skills/gstack/bin/gstack-review-log '{"skill":"plan-devex-review","timestamp":"TIMESTAMP","status":"STATUS","initial_score":N,"overall_score":N,"product_type":"PRODUCT_TYPE","tthw_current":"TTHW_CURRENT","tthw_target":"TTHW_TARGET","mode":"MODE","persona":"PERSONA","competitive_tier":"COMPETITIVE_TIER","unresolved":N,"commit":"COMMIT"}'
```

TIMESTAMP = current ISO 86[object Object][object Object] datetime; STATUS = "clean" if score 8+ AND [object Object] unresolved, else "issues_open"; other fields from the DX Scorecard + Step [object Object]; COMMIT = `git rev-parse --short HEAD`.
...
to record a take with weight [object Object].6 (per SKILL_CALIBRATION_WEIGHTS).
...
be [target from [object Object]C]. Did reality match? Run /devex-review on the live product to find
...
Passes       | All 8, expanded  | All 8, standard    | Pass [object Object] + 3 only
